...
int totalwords=0;
void addword(char*);
void modifyXml(char* orderby, int distinct);
void ResetFlags();
...
{
       0,     0,     3,     5,     9,    11,    14,    17,    21,    26,
      32,    35,    38,    40,    42,    44,    48,    50,    54,    56,
      60,    62,    66,    68,    71,    73,    77,    81,    83,    87,
      91,    93,    97,   101,   103,   105,   107
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      30,     0,    -1,    31,    -1,    24,    30,    25,    -1,    32,
      -1,    32,    33,    -1,    32,    34,    -1,    32,    33,    34,
      -1,     3,    35,     4,    37,    -1,     3,    17,    35,     4,
      37,    -1,     5,    38,    -1,    18,     9,    -1,     8,    -1,
      36,    -1,     9,    -1,    36,    21,     9,    -1,    15,    -1,
      37,    21,    15,    -1,    39,    -1,    38,     7,    39,    -1,
      40,    -1,    40,     6,    39,    -1,    41,    -1,    20,    41,
      -1,    42,    -1,    24,    38,    25,    -1,    43,    16,    43,
      -1,    44,    -1,    44,    22,    43,    -1,    44,    23,    43,
      -1,    45,    -1,    45,     8,    44,    -1,    45,    27,    44,
      -1,     9,    -1,    10,    -1,    11,    -1,    24,    43,    25,
      -1
};
...
{
       0,    71,    71,    72,    74,    75,    76,    77,    80,    81,
      95,    97,   100,   101,   104,   105,   108,   108,   125,   126,
     129,   130,   132,   133,   136,   137,   140,   142,   143,   144,
     146,   147,   148,   150,   152,   154,   156
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ASTERIX", "COLUMN_NAME", "LITERAL", "INTEGER", "DIGIT", "LETTER",
  "ATTRIBUTE_NAME", "TABLE_NAME", "COMP_OP", "DISTINCT", "ORDERBY",
  "NULLe", "NOTe", "COMMA", "PLUS", "MINUS", "OPENBR", "CLOSEBR", "MULT",
  "DIVIDE", "','", "$accept", "Query", "SFW", "SF", "W", "O", "SelList",
  "SelSubList", "TableList", "Search_Condition", "boolean_term",
...
{
       0,     0,     0,     0,     2,     4,    12,    14,     0,     0,
      13,     0,     1,     0,     0,     5,     6,     0,     0,     0,
       3,    33,    34,    35,     0,     0,    10,    18,    20,    22,
      24,     0,    27,    30,    11,     7,     0,    16,     8,    15,
      23,     0,     0,     0,     0,     0,     0,     0,     0,     0,
       9,     0,    25,    36,    19,    21,     0,    26,    28,    29,
      31,    32,    17,     0
};
...
{
      -1,     1,    -1,     8,   -26,    12,   -26,   -26,    -5,    24,
      14,    16,   -26,     5,    33,    25,   -26,    40,    30,    37,
     -26,   -26,   -26,   -26,     2,     5,    41,   -26,    43,   -26,
     -26,    34,   -16,    -3,   -26,   -26,    30,   -26,    31,   -26,
     -26,    -6,    11,     5,     5,    23,    23,    23,    23,    23,
      31,    36,   -26,   -26,   -26,   -26,    23,   -26,   -26,   -26,
     -26,   -26,   -26,    28
};
...
{
      42,    43,     1,     6,     7,    48,    46,    47,    12,     6,
       7,    21,    22,    23,    21,    22,    23,    13,     8,    52,
      57,    58,    59,     2,    49,    24,    25,    45,    18,    25,
      14,    63,    21,    22,    23,    19,    53,    60,    61,    54,
      55,    20,    34,    14,    36,    37,    39,    56,    43,    44,
      45,    62,    51,    53,    11,    17,    50,    35,     0,     0,
      41,     0,    40
};

static const yytype_int8 yycheck[] =
{
      25,     7,     3,     8,     9,     8,    22,    23,     0,     8,
       9,     9,    10,    11,     9,    10,    11,     5,    17,    25,
      45,    46,    47,    24,    27,    20,    24,    16,     4,    24,
      18,    56,     9,    10,    11,    21,    25,    48,    49,    43,
      44,    25,     9,    18,     4,    15,     9,    24,     7,     6,
      16,    15,    21,    25,     2,     8,    36,    15,    -1,    -1,
      25,    -1,    24
};
...
{
       0,     3,    24,    30,    31,    32,     8,     9,    17,    35,
      36,    30,     0,     5,    18,    33,    34,    35,     4,    21,
      25,     9,    10,    11,    20,    24,    38,    39,    40,    41,
      42,    43,    44,    45,     9,    34,     4,    15,    37,     9,
      41,    38,    43,     7,     6,    16,    22,    23,     8,    27,
      37,    21,    25,    25,    39,    39,    24,    43,    43,    43,
      44,    44,    15,    43
};
...
void modifyXml(char* orderby, int ifDISTINCT)
{
char* new=(char*)malloc(100*sizeof(char));
strcpy(new,"<SFW ORDERBY=");
strcat(new,orderby);
strcat(new," DISTINCT=");
if(ifDISTINCT)
strcat(new,"TRUE");
